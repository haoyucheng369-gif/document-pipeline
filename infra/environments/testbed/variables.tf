variable "location" {
  description = "Azure region for testbed resources."
  type        = string
...
variable "sql_connection_string" {
  description = "SQL connection string used by the testbed runtime."
  type        = string
  sensitive   = true
}

variable "blob_connection_string" {
  description = "Blob Storage connection string used by the testbed runtime."
  type        = string
  sensitive   = true
}

variable "service_bus_connection_string" {
  description = "Service Bus connection string used by the testbed runtime."
  type        = string
  sensitive   = true
}
